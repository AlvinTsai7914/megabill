<?php
require_once 'situation_detail_head.php';
?>
<div class="wrapper">
    ...
    <div class="breadcrumb">
        <div class="breadcrumb__wrapper">
            ...
            <li>永續發展</li>
            <li><a href="<?= BASE_PATH ?>/situation_list"><?= $g_page_c_name ?></a ></li>
            <li class="current"><?= $situation["name"] ?></li>
        </div>
    </div>
    <main class="pg">
        <div class="container">
            <h1 class="pg_title mb-0"><?= $situation["name"] ?></h1>
        </div>
        <?= $situation["content"] ?>
    </main>
