...
$url = WEBAPI_BUSINESS . "?query=" . urlencode($querystring);
if (CallAPI('GET', $url, null, null, $resultMessage, $businesss) == 200 && is_array($businesss) && count($businesss) == 1) {
    $business = $businesss[0];
}
