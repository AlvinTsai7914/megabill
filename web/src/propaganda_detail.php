<?php
require_once 'propaganda_detail_head.php';
?>
<div class="wrapper">
    ...
    <div class="breadcrumb">
        <div class="breadcrumb__wrapper">
            ...
            <li>動態消息</li>
            <li><a href="<?= BASE_PATH ?>/propaganda_list"><?= $g_page_c_name ?></a ></li>
            <li class="current"><?= $propaganda["name"] ?></li>
        </div>
    </div>
    <main class="pg">
        <div class="container">
            <h1 class="pg_title mb-0"><?= $propaganda["name"] ?></h1>
            <p class="date"><?= GetDateString($propaganda["release_date"]) ?></p>
        </div>
        <?= $propaganda["content"] ?>
    </main>
