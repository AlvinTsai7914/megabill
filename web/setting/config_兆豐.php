...
const ENVIRONMENT = "test"; //development;test;formal
//開發
const API_ACCOUNT = "web_server";
const API_PASSWORD = "c7y2rQ3P";
const API_SERVER = 'http://localhost:8081'; //WebAPI連線設定
const API_BASEURL = '';
const ROOT_PATH = 'D:/web';
const BASE_PATH = '';
...
const ORACLE_USERNAME = 'ECT';
const ORACLE_PASSWORD = 'ECTXX';
