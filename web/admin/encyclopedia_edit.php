...
if (GetPreviousPageName() != "encyclopedia_list")
    redir("encyclopedia_list.php");

$encyclopedia_id = request_num('edit_id');
if ($encyclopedia_id == '')
    redir("encyclopedia_list.php");
...
if ($encyclopedia_id != 0) {
    $url = WEBAPI_ENCYCLOPEDIA . "/" . $encyclopedia_id;
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    <form name="edit_form" id="edit_form" action="encyclopedia_edit_ajax.php" data-toggle="validator" role="form">
                        <input type="hidden" id="encyclopedia_id" name="encyclopedia_id" value="<?= $id ?>">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-2">
...
<script>
    ...
    function ajaxCallback(status, form, json, options) {
        ...
        if (status === true) {
            if (json.result == true)
                success_brand_alert("貨幣市場小百科<?= $sub_title ?>成功", "", "javascript:history.go(-1)");
            else
                error_brand_alert("貨幣市場小百科<?= $sub_title ?>失敗", json.msg);
        } else {
            error_brand_alert("貨幣市場小百科<?= $sub_title ?>失敗", json.msg);
        }
    }
