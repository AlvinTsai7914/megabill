...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    <form name="edit_form" id="edit_form" action="about_edit_ajax.php" data-toggle="validator" role="form">
                        <input type="hidden" id="sysinfo_id" name="sysinfo_id" value="<?= $id ?>">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-2">
                                    <label for="about" class="col-md-1">內容<br>
                                        ...
                                        <button type="button" class="btn btn-sm btn-brand clear_template_btn" data-target="about"><i class="fas fa-eraser"></i></button>
                                    </label>
                                    <div class="col-md-11">
                                        <textarea name="about" id="about" class="form-control validate[required]" rows="15"><?= $about ?></textarea>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function ajaxCallback(status, form, json, options) {
        ...
        if (status === true) {
            if (json.result === true)
                success_brand_alert("關於兆票<?= $sub_title ?>成功", "", "about_edit.php");
            else
                error_brand_alert("關於兆票<?= $sub_title ?>失敗", json.msg);
        } else {
            error_brand_alert("關於兆票<?= $sub_title ?>失敗", json.msg);
        }
    }
