...
if (GetPreviousPageName() != "norm_list")
    redir("norm_list.php");

$norm_id = request_num('edit_id');
if ($norm_id == '')
    redir("norm_list.php");
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    <form name="edit_form" id="edit_form" action="norm_edit_ajax.php" data-toggle="validator" role="form">
                        <input type="hidden" id="norm_id" name="norm_id" value="<?= $id ?>">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-2">
...
<script>
    ...
    function ajaxCallback(status, form, json, options) {
        ...
        if (status === true) {
            if (json.result == true)
                success_brand_alert("公司治理規範<?= $sub_title ?>成功", "", "javascript:history.go(-1)");
            else
                error_brand_alert("公司治理規範<?= $sub_title ?>失敗", json.msg);
        } else {
            error_brand_alert("公司治理規範<?= $sub_title ?>失敗", json.msg);
        }
    }
